 ...
 *
 * <p>1분마다 모은 메트릭(steps, calories, heart_rate)을 5분 단위 batch로 INSERT. Hibernate {@code saveAll}은
 * batch 내 중복 1건이 발생하면 전체 트랜잭션이 실패하므로 Postgres {@code INSERT ... ON CONFLICT DO NOTHING}을
 * JdbcTemplate batchUpdate로 실행한다.
 *
