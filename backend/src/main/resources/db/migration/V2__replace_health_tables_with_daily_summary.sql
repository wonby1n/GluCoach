...
COMMENT ON COLUMN daily_health_summaries.sleep_start    IS '수면 시작 시각 (타임라인 핀용)';
COMMENT ON COLUMN daily_health_summaries.sleep_end      IS '수면 종료 시각 (타임라인 핀용)';
COMMENT ON COLUMN daily_health_summaries.sleep_minutes  IS '수면 시간 (분)';
